...
def owner_ads_text() -> str:
    return (
        ...
        "• зарабатывать на рекламных постах;\n"
        "• рекламные сообщения для новых и постоянных гостей;\n"
        "• отдельные офферы на утро, обед и вечер.\n\n"
        "Идея простая: не просто наливать кофе, а системно приводить людей обратно или просто получать дополнительный заработок с помощью реклмы."
    )
